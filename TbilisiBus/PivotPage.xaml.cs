using TbilisiBus.Common;
using TbilisiBus.Data;
using System;
...
namespace TbilisiBus
{
    public sealed partial class PivotPage : Page
    {
        ...
        public PivotPage()
        {
            ...
            mapControl.CenterChanged += MapChanged;
            mapControl.ZoomLevelChanged += MapChanged;
        ...
        private async void CenterToLocation()
        {
            Geoposition myPosition = await new Geolocator().GetGeopositionAsync();
            mapControl.Center = myPosition.Coordinate.Point;
            mapControl.ZoomLevel = 17;
        }

        private void MapChanged(MapControl map, Object param)
        {
